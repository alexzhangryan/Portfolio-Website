    ...
    return(
        <>
            ...
            <div className="mb-30">
                ...
                <ProjectCard title="Image Classifer With Pytorch" desc="A sample image classifer writen in Python using the Pytorch library. Trained on a dataset consisting of playing cards. Will be repurposed in future projects to keep the framework." img="imageClassifer.png" index={2} skills1="Python" skills2="Pytorch" skills3="Machine Learning"/>
                <ProjectCard title="This Website!" desc="A portfolio website for myself, Alex Ryan, written in TypeScript. Utilizes the React framework as well as TailwindCSS." img="website.png" index={3} skills1="TypeScript" skills2="React" skills3="TailwindCSS"/>
            </div>
